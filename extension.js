...
const workspaceExists = () => new Promise((res, rej) => (vscode.workspace.name ? res() : rej()));
...
function activate(context) {
  ...
  vscode.commands.getCommands().then((commands) => new Promise((res, rej) => (commands.find((command) => command.includes('snipsnap_activate'))
    ? rej()
    : res()))
    .then(() => {
